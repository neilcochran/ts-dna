/**
 * Module-private construction key used by `processing/`-internal `unsafe*` factories.
 *
 ...
 * the validation logic. Files inside `src/processing/` may import it; package consumers
 * cannot reach it because the symbol is not re-exported from the barrel.
 *
 * @internal
 */
