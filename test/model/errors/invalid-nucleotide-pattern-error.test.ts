...
describe('InvalidNucleotidePatternError', () => {
  ...
  describe('invalid IUPAC codes', () => {
    test('handles invalid single character codes', () => {
      const error = new InvalidNucleotidePatternError('Invalid IUPAC code X found', 'X');
    ...
    test('handles multiple invalid characters', () => {
      const error = new InvalidNucleotidePatternError('Invalid IUPAC codes X, Z found', 'AXZG');
  ...
  describe('pattern length and structure errors', () => {
    test('handles empty patterns', () => {
      const error = new InvalidNucleotidePatternError('Pattern cannot be empty', '');
  ...
  describe('case sensitivity errors', () => {
    ...
    test('handles mixed case with invalid characters', () => {
      const error = new InvalidNucleotidePatternError('Mixed case with invalid character', 'AxtG');

      expect(error.nucleotidePattern).toBe('AxtG');
    });

    test('handles valid IUPAC codes in wrong case', () => {
      const error = new InvalidNucleotidePatternError('IUPAC codes must be uppercase', 'wrks');
  ...
  describe('unicode and special character handling', () => {
    ...
    test('handles mathematical symbols', () => {
      const error = new InvalidNucleotidePatternError('Mathematical symbols not allowed', 'AT±GC');
  ...
  describe('error message handling', () => {
    ...
    test('handles complex error messages', () => {
      const complexMessage =
        'Invalid IUPAC nucleotide pattern "AXTG" contains invalid character "X" at position 1. Valid IUPAC codes are: A, C, G, T, U, R, Y, S, W, K, M, B, D, H, V, N.';
  ...
  describe('IUPAC code validation context', () => {
    test('handles invalid degeneracy codes', () => {
      const error = new InvalidNucleotidePatternError('Invalid degeneracy code Q found', 'AQTG');
  ...
  describe('edge cases and boundary conditions', () => {
    test('handles single character patterns', () => {
      const error = new InvalidNucleotidePatternError('Single character pattern invalid', 'X');
    ...
    test('handles null-like strings', () => {
      const error = new InvalidNucleotidePatternError('Invalid null-like pattern', 'null');
    ...
    test('handles boolean-like strings', () => {
      const error = new InvalidNucleotidePatternError('Invalid boolean-like pattern', 'true');
